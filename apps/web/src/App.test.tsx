...
describe('App', () => {
  ...
  it('renders a unified status strip for signed-in state', async () => {
    ...
    expect(screen.getByLabelText('Connection is closed')).toBeInTheDocument();
    expect(screen.getByLabelText('Notification permission is unsupported')).toBeInTheDocument();
  });
