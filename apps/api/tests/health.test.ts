...
const baseDeps = {
  ...
  getServerAiSettings: vi.fn().mockResolvedValue({
    serverId: 'server-1',
    enabled: false,
    botDisplayName: 'assistant',
    model: 'gpt-4.1-mini',
    systemPrompt: null,
    maxTokensPerReply: null,
    maxPromptChars: null,
    maxCompletionTokens: null,
    rateLimitUserRequests: null,
    rateLimitServerRequests: null,
    rateLimitWindowSeconds: null,
    burstLimitRequests: null,
    burstWindowSeconds: null,
    dailyTokenBudget: null,
    monthlyTokenBudget: null,
    autoDisableOnBudgetExceeded: false,
    disabledReason: null,
    temperature: null,
    allowDmInvocation: false,
  }),
